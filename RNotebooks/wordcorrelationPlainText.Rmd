...
The following word correlation script aims to discover the semantic proximity of two words throughout the Shakespeare Drama Corpus. At the end, it will take in a word of the user's choice and find the top ten words that correlate using pearson's correlation coefficient. 
...
![Word Correlation Plain Text results](./result-imgs/cooccurrencePlainText2.png)
