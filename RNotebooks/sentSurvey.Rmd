...
```{r}
faculty.text <- scan("data/survey/2015UITSFaculty.txt", what = "character", sep="\n")
staff.text <- scan("data/survey/2015UITSStaff.txt", what = "character", sep="\n")
grad.text <- scan("data/survey/2015UITSGrad.txt", what = "character", sep="\n")
undergrad.text <- scan("data/survey/2015UITSUndergrad.txt", what = "character", sep="\n")
```
