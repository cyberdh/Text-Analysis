...
***
```{r}
faculty.text <- scan("~/Documents/IU/CyberDH/Text_Analysis/data/survey/2015UITSFaculty.txt", what = "character", sep="\n")
staff.text <- scan("~/Documents/IU/CyberDH/Text_Analysis/data/survey/2015UITSStaff.txt", what = "character", sep="\n")
grad.text <- scan("~/Documents/IU/CyberDH/Text_Analysis/data/survey/2015UITSGrad.txt", what = "character", sep="\n")
undergrad.text <- scan("~/Documents/IU/CyberDH/Text_Analysis/data/survey/2015UITSUndergrad.txt", what = "character", sep="\n")
```
***   
