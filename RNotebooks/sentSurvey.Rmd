...
```{r}
faculty.text <- scan("/N/home/c/y/cyberdh/Text-Analysis/data/survey/2015UITSFaculty.txt", what = "character", sep="\n")
staff.text <- scan("/N/home/c/y/cyberdh/Text-Analysis/data/survey/2015UITSStaff.txt", what = "character", sep="\n")
grad.text <- scan("/N/home/c/y/cyberdh/Text-Analysis/data/survey/2015UITSGrad.txt", what = "character", sep="\n")
undergrad.text <- scan("/N/home/c/y/cyberdh/Text-Analysis/data/survey/2015UITSUndergrad.txt", what = "character", sep="\n")
```
...
```{r}
lex.pos = scan('/N/home/c/y/cyberdh/Text-Analysis/data/opinionLexicon/positive-words.txt', what='character', comment.char = ';')
lex.neg = scan('/N/home/c/y/cyberdh/Text-Analysis/data/opinionLexicon/negative-words.txt', what='character', comment.char = ';')
```
