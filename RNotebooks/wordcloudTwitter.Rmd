...
output: pdf_document
---
## Wordcloud of Top 100 Words in tweets using the keyword "brussels"
***
Using 3200 tweets with the hashtag #brussels from March 23, 2016, we will create a wordcloud of the top words used to describe Winter Storm Jonas.
...
***
```{r}
load(file = "~/Desktop/R/Text_Analysis/data/twitter/brussels.RData")
```
...
***
```{r}
plot = wordcloud(words,freqs,scale=c(3,.7),max.words=100, rot.per=0, 
