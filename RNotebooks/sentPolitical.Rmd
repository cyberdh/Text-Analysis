...
```{r}
  ...
  cruz.tweets <- readRDS("data/twitter/tweetssanders.RData")
  sanders.tweets <- readRDS("data/twitter/tweetstrump.RData")
  trump.tweets <- readRDS("data/twitter/tweetscruz.RData")
```
...
![Sent Political results](./result-imgs/sentPolitical.png)
