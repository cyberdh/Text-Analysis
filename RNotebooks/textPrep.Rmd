...
```{r}
text <- scan("~/Desktop/Text-Analysis/data/bronte/janeEyre.txt", what="character", sep="\n")
```
...
```{r}
potatoes <- scan("~/Desktop/Text-Analysis/data/bronte/janeEyre.txt", what="character", sep="\n")
```
