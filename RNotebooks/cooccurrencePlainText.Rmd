...
OR
If you are using RStudio, click Session in the menu bar > Set Working Directory > Choose Directory, then select the Text_Analysis directory in which you are working.
***
```{r}
