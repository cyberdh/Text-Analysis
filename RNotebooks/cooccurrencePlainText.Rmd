...
```{r}
corpus <- Corpus(DirSource("N/home/c/y/cyberdh/Text-Analysis/data/shakespeareFolger"))
```
...
myStopWords <- scan("N/home/c/y/cyberdh/Text-Analysis/data/earlyModernStopword.txt", what="character", sep="\n")
