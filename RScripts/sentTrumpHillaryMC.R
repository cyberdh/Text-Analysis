...
# Load data 
a <- load("/N/home/c/y/cyberdh/Karst/Text-Analysis/data/twitter/trump/realdonaldtrump2016-07-07.RData")
b <- load("/N/home/c/y/cyberdh/Karst/Text-Analysis/data/twitter/trump/realdonaldtrump2016-07-08.RData")
c <- load("/N/home/c/y/cyberdh/Karst/Text-Analysis/data/twitter/trump/realdonaldtrump/2016-07-09.RData")
d <- load("/N/home/c/y/cyberdh/Karst/Text-Analysis/data/twitter/trump/realdonaldtrump2016-07-10.RData")
e <- load("/N/home/c/y/cyberdh/Karst/Text-Analysis/data/twitter/trump/realdonaldtrump2016-07-11.RData")
f <- load("/N/home/c/y/cyberdh/Karst/Text-Analysis/data/twitter/trump/realdonaldtrump2016-07-12.RData")
rbind(a,b,c,d,e,f)
trump.text = sapply(tweets, function(x) x$text)
g< - load("/N/home/c/y/cyberdh/Karst/Text-Analysis/data/twitter/hillary/hillaryclinton2016-07-07.RData")
h <- load("/N/home/c/y/cyberdh/Karst/Text-Analysis/data/twitter/hillary/hillaryclinton2016-07-08.RData")
i <- load("/N/home/c/y/cyberdh/Karst/Text-Analysis/data/twitter/hillary/hillaryclinton2016-07-09.RData")
j <- load("/N/home/c/y/cyberdh/Karst/Text-Analysis/data/twitter/hillary/hillaryclinton2016-07-10.RData")
k <- load("/N/home/c/y/cyberdh/Karst/Text-Analysis/data/twitter/hillary/hillaryclinton2016-07-11.RData")
l <- load("/N/home/c/y/cyberdh/Karst/Text-Analysis/data/twitter/hillary/hillaryclinton2016-07-12.RData")
rbind(g,h,i,j,k,l)
