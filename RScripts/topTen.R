...
setwd("/N/home/c/y/cyberdh/Karst/Text_Analysis/data/shakespeareFolger")
...
myStopWords <- scan("/N/home/c/y/cyberdh/Karst/Text_Analysis/data/earlyModernStopword.txt", what="character", sep="\n")
...
write.csv(head(freq, 10), file = "/N/home/c/y/cyberdh/Karst/Text_Analysis/Hamlet.csv")
