...
# Load data 
load("/N/home/c/y/cyberdh/Karst/Text-Analysis/data/twitter/trump/realdonaldtrump2016-07-11.RData")
trump.text = sapply(tweets, function(x) x$text)
load("/N/home/c/y/cyberdh/Karst/Text-Analysis/data/twitter/hillary/hillaryclinton2016-07-11.RData")
...
write.csv(trump.result, file = "/N/home/c/y/cyberdh/Karst/TrumpResultDF.csv")
write.csv(hillary.result, file = "/N/home/c/y/cyberdh/Karst/ClintonResultDF.csv")
write.csv(df.result, file = "/N/home/c/y/cyberdh/Karst/BothResultDF.csv")
