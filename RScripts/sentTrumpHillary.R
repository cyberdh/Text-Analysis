...
# Load data 
load("/N/home/c/y/cyberdh/Karst/Text_Analysis/data/twitter/TrumpOct4.RData")
...
write.csv(trump.result, file = "/N/home/c/y/cyberdh/Karst/Text_Analysis/TrumpResultDF.csv")
write.csv(hillary.result, file = "/N/home/c/y/cyberdh/Karst/Text_Analysis/ClintonResultDF.csv")
write.csv(df.result, file = "/N/home/c/y/cyberdh/Karst/Text_Analysis/BothResultDF.csv")
